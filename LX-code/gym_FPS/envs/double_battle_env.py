...
class doubleBattleEnv(fc.FPSEnv):
    ...
    def _make_observation(self):
        ...
        #----------------------my wall---------------------------------
        # for i in range(75,180):
        #     for j in range(40,150):
        #         center_y = int(round(i))
        #         center_x = int(round(j))
        #         screen_my[center_x][center_y] = 1
        #         center_y = 99-int(round(i))
        #         screen_enemy[center_x][center_y] = 1
        # for i in range(80,175):
        #     for j in range(45,145):
        #         center_y = int(round(i))
        #         center_x = int(round(j))
        #         screen_my[center_x][center_y] = 0
        #         center_y = 99-int(round(i))
        #         screen_enemy[center_x][center_y] = 1
        ...
        #     center_y = 99-int(round(i))
        #     center_x = int(round(174))
        #     screen_enemy[center_x][center_y] = 1
        #     center_x = int(round(74))
        #     screen_enemy[center_x][center_y] = 1
